...
@click.option('--proxy-type', default='socks5', help='Proxy type (socks5, socks4, http)')
...
def set_proxy(host, port, proxy_host, proxy_port, proxy_type, username, password, use_tor):
...
@click.option('--host', default='localhost', help='Go node host')
@click.option('--port', default=8080, help='Go node RPC port')
@click.option('--type', 'enc_type', type=click.Choice(['asymmetric', 'symmetric', 'none']), 
              required=True, help='Encryption type')
@click.option('--key-exchange', default='rsa', help='Key exchange algorithm (rsa, ecc, dh)')
@click.option('--symmetric-algo', default='aes256', help='Symmetric algorithm (aes256, chacha20)')
@click.option('--signatures/--no-signatures', default=True, help='Enable digital signatures')
...
@click.option('--encryption', type=click.Choice(['asymmetric', 'symmetric', 'none']), 
              default='asymmetric', help='Encryption type')
