...
class PeerHealthManager:
    ...
    def __init__(self, health_threshold: float = 0.5):
        ...
        self.potential_ips: List[Tuple[str, int]] = []  # List of (host, port) for reconnection
    ...
    def update_peer_quality(self, peer_id: int, latency: float, jitter: float, packet_loss: float):
