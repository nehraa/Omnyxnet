...
use pangea_ces::{CesConfig, CesPipeline, CompressionAlgorithm, AudioConfig, AudioEncoder, AudioDecoder, MetricsTracker, LatencyTimer};
use std::sync::Arc;
...
fn main() -> anyhow::Result<()> {
    ...
    for alg in [CompressionAlgorithm::Zstd, CompressionAlgorithm::Brotli] {
        ...
        let cfg = CesConfig {compression_level: 3, compression_algorithm: alg, shard_count: 8, parity_count: 4, chunk_size: 1024*1024};
