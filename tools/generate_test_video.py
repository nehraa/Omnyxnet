...
def generate_test_video(output_path: str, duration: int = 10, fps: int = 30, width: int = 640, height: int = 480):
    """
    ...
    for frame_num in range(total_frames):
        ...
        # Color indicator
        color_name = ["Blue", "Green", "Red", "Cyan", "Magenta", "Yellow", "White", "Gray"][color_idx]
        color_text = f"Color: {color_name}"
        cv2.putText(frame, color_text, (width - 250, height - 20), font, 0.8, (0, 0, 0), 3)
        cv2.putText(frame, color_text, (width - 250, height - 20), font, 0.8, (255, 255, 255), 2)
