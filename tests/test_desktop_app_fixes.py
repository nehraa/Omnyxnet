...
def test_schema_field():
    ...
    try:
        ...
        try:
            ...
            print("✅ ChatMessage has 'message' field")
            return True
        except Exception as e:
...
def test_multiaddr_ip_replacement():
    ...
    test_cases = [
        (
            "/ip4/0.0.0.0/tcp/7777/p2p/QmTest",
            "192.168.1.100",
            "/ip4/192.168.1.100/tcp/7777/p2p/QmTest",
        ),
        (
            "/ip4/127.0.0.1/tcp/7777/p2p/QmTest",
            "192.168.1.100",
            "/ip4/192.168.1.100/tcp/7777/p2p/QmTest",
        ),
        (
            "/ip4/192.168.1.50/tcp/7777/p2p/QmTest",
            "192.168.1.100",
            "/ip4/192.168.1.50/tcp/7777/p2p/QmTest",
        ),  # Should not change
    ]
