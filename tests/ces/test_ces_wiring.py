...
def test_ces_process_reconstruct():
    ...
    try:
        # Test data
        test_data = (
            b"Hello, CES Pipeline! This is a test of the Compression, Encryption, and Sharding system."
            * 10
        )
        ...
        reconstructed = client.ces_reconstruct(
            shards, shard_present, compression_level=3
        )
