...
class ObservabilityManager:
    ...
    def get_s3_client(self):
        ...
        if self.aws_session:
            return self.aws_session.client(
                "s3", endpoint_url=self.localstack_endpoint_url, use_ssl=False
            )
        return None
    ...
    def get_sqs_client(self):
        ...
        if self.aws_session:
            return self.aws_session.client(
                "sqs", endpoint_url=self.localstack_endpoint_url, use_ssl=False
            )
        return None
    ...
    def get_dynamodb_client(self):
        ...
        if self.aws_session:
            return self.aws_session.client(
                "dynamodb", endpoint_url=self.localstack_endpoint_url, use_ssl=False
            )
        return None
    ...
    def get_lambda_client(self):
        ...
        if self.aws_session:
            return self.aws_session.client(
                "lambda", endpoint_url=self.localstack_endpoint_url, use_ssl=False
            )
        return None
